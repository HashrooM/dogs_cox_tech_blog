...
![data spreadsheet](/images/google_dataportal_analysis/data_spreadsheet.png "data_spreadsheet")  
...
![report first](/images/google_dataportal_analysis/report_first.png "report_first")    
...
![set_dimensions](/images/google_dataportal_analysis/set_dimensions.png "dimensions")  
...
![add_param](/images/google_dataportal_analysis/add_params.png "add_param")   
...
すると、画面下部に以下のようにパラメータを入力する画面が現れるので、  
 ...
 ![make_param](/images/google_dataportal_analysis/make_params.png "make_param")   

次に、指標 `IMDb_devided_by_MAX` を作成します。  

画面右下の "フィールドの追加" をクリックします。  
![add_field](/images/google_dataportal_analysis/add_field.png "add_field")  
...
![make_field](/images/google_dataportal_analysis/make_field.png "make_field")  

では、フィルタを作成します。  

画面右側から、 "フィルタを追加" をクリックします。  
![add_filter](/images/google_dataportal_analysis/add_filter.png "add_filter")  
...
入力したら、"保存" をクリックします。  
![make_filter](/images/google_dataportal_analysis/make_filter.png "make_filter")  

これでIMDbの評価点が上位10%以内の映画タイトルだけが表に表示されました。  
表の下部にある全体の数値が減っていることからも確認できると思います。  
![table_filtered](/images/google_dataportal_analysis/table_filtered.png "table_filtered")  
...
ここまで行うと、次のような棒グラフが作成されます。  
 ...
 ![bar plot](/images/google_dataportal_analysis/bar_plot.png "bar_plot")  
...
![bar plot filtered](/images/google_dataportal_analysis/bar_plot_filtered.png "bar_plot_filtered")  
...
![action](/images/google_dataportal_analysis/table_action.png "action")   
...
![IMDb](/images/google_dataportal_analysis/imdb.png "imdb")  

Rotten Tomatoesベースの集計は次の画像のようになりました。  
![RT](/images/google_dataportal_analysis/rt.png "rt")  
